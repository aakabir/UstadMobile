 ...
 *
 */
public class CoreLoginModule extends AbstractPresenterModule {
	
    @Override
    protected void configure() {
        bindPresenter(CoreLoginPresenter.class, 
        		CoreLoginPresenter.MyView.class, 
        		CoreLoginView.class, 
        		CoreLoginPresenter.MyProxy.class);
    }
}
