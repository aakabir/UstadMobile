...
describe('#ContentTemplates', function() {
    ...
    describe("-Questions",function () {
        ...
        describe('givenActiveEditor_whenMultipleChoiceTemplateIsSelected_thenShouldShouldInsertMultipleChoiceNode', function() {
        ...
        describe('givenActiveEditor_whenFillInTheBlanksTemplateIsSelected_thenShouldShouldInsertFillInTheBlanksNode', function() {
    ...
    describe("-Multimedia",function () {
        ...
        describe('givenActiveEditor_whenMediaTypeImageIsSelected_thenShouldShouldInsertImageNode', function() {
